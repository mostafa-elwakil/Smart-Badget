...
export default function Income() {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={t('addIncome')}>
                <form className="space-y-4" onSubmit={async (e) => {
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                        ...
                        <Button type="submit" className="bg-green-600 hover:bg-green-700">{t('addIncome')}</Button>
                    </div>
                </form>
            </Modal>
        </div>
